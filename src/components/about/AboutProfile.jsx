  ...
  return (
    ...
    <div className='about-card'>
        <div className='about-card-img'>
            <img src='about-card-profile.jpeg' alt='About Rudra Karmakar'/>
        </div>
    ...
    <div data-aos="fade-up"
            data-aos-duration="1000" class="contact-buttons socialicnz">
            {/* <div><h4>MY SOCIALS</h4></div> */}
    ...
    <div data-aos="fade-up"
            data-aos-duration="1000" className='contact-mail about'>
            <p><span><svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                ...
                : Medinipur, Westbengal, Pin-721253.
            </p>          
          </div>
